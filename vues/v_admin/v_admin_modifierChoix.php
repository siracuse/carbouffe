    ...
    <div class="row">
        ...
        <a href="javascript:window.location.reload()">
            <div class="col l4 m6 s12">
                <div class="card green white-text valign-wrapper">
                    <div class=" icon valign-wrapper">
                        <i class="material-icons medium valign">cached</i>
                    </div>
                    <div class="card-content">
                        <div class="row">
                            <h3 class="card-stats-number">Actualiser</h3>
                        </div>
                    </div>
                </div>
            </div></a><a href="index_dashboard.php">
                <div class="col l4 m6 s12">
                    <div class="card blue  white-text valign-wrapper">
                        <div class="  icon valign-wrapper">
                            <i class="material-icons medium valign">replay</i>
                        </div>
                        <div class="card-content">
                            <div class="row">
                                <h3 class="card-stats-number">Retour</h3>
                            </div>
                        </div>
                    </div>
                </div></a>
                <a href="index_dashboard.php">
                    <div class="col l4 m6 s12">
                        <div class="card orange white-text valign-wrapper">
                            ...
                            <div class="card-content">
                                <div class="row">
                                    <h3 class="card-stats-number">Accueil</h3>
                                </div>
                            </div>
                        </div>
                    </div></a>
